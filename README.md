...
// Android/JVM
dependencies {
  implementation("com.eygraber:sqldelight-androidx-driver:0.5.0-alpha.8")
}
...
val webMain by getting {
  dependencies {
    implementation("com.eygraber:sqldelight-androidx-driver-opfs:0.5.0-alpha.8")
  }
}
```
...
```kotlin
dependencies {
  implementation("com.eygraber:sqldelight-coroutines-extensions:0.5.0-alpha.8")
}
```
