...
// Android/JVM
dependencies {
  implementation("com.eygraber:sqldelight-androidx-driver:0.5.0-alpha.10")
}
...
val webMain by getting {
  dependencies {
    implementation("com.eygraber:sqldelight-androidx-driver-opfs:0.5.0-alpha.10")
  }
}
```
...
```kotlin
dependencies {
  implementation("com.eygraber:sqldelight-coroutines-extensions:0.5.0-alpha.10")
}
```
